...
/* ========================================= */
/* Vérifie l'existence de tags incompatibles */
/* ========================================= */
...
/* ====================================================== */
/* Supprime deux tags incompatibles de la base de données */
/* ====================================================== */
void SupprimerTagIncompatible(char* tag1, char* tag2) {
	...
	sprintf(sql_buf,DELETE_INCTAG,tag1,tag2,tag1,tag2);
	...
	printf("\nLes tags \033[33m%s\033[00m et \033[33m%s\033[00m ne sont plus incompatibles\n\n",tag1,tag2);
	free(sql_buf), sql_buf = NULL;
}
...
int main(int argc, char **argv) {
	...
	if(argc != 3) {
		fprintf(stderr, "\033[04mUsage:\033[00m delincompatibletag nom_du_tag1 nom_du_tag2\n");
		exit(1);
	}
	//ouvre la base
	...
	//si les tags sont bien incompatibles, on les supprime de la base de données
	int exist = VerifierExistTagIncompatible(argv[1],argv[2]);
	if (exist == 1)
		SupprimerTagIncompatible(argv[1],argv[2]);
	else
		printf("\nLes tags \033[33m%s\033[00m et \033[33m%s\033[00m n'ont pas été trouvés comme incompatibles\n\n",argv[1],argv[2]);
	sqlite3_close(db);
	return EXIT_SUCCESS;
}
